...
#ifndef BKFIXEDNOTESYNTHESISER_H_INCLUDED
#define BKFIXEDNOTESYNTHESISER_H_INCLUDED
...
//==============================================================================
/**
 Describes one of the sounds that a BKFixedNoteSynthesiser can play.
 
 A BKFixedNoteSynthesiser can contain one or more sounds, and a sound can choose which
 midi notes and channels can trigger it.
 
 The BKFixedNoteSynthesiserSound is a passive class that just describes what the sound is -
 the actual audio rendering for a sound is done by a BKFixedNoteSynthesiserVoice. This allows
 more than one BKFixedNoteSynthesiserVoice to play the same sound at the same time.
 
 @see BKFixedNoteSynthesiser, BKFixedNoteSynthesiserVoice
 */
class BKFixedNoteSynthesiserSound    : public ReferenceCountedObject
{
protected:
    //==============================================================================
    BKFixedNoteSynthesiserSound();
    
public:
    /** Destructor. */
    virtual ~BKFixedNoteSynthesiserSound();
    
    //==============================================================================
    /** Returns true if this sound should be played when a given midi note is pressed.
     
     The BKFixedNoteSynthesiser will use this information when deciding which sounds to trigger
     for a given note.
     */
    ...
    typedef ReferenceCountedObjectPtr<BKFixedNoteSynthesiserSound> Ptr;
    
    
private:
    //==============================================================================
    JUCE_LEAK_DETECTOR (BKFixedNoteSynthesiserSound)
};


//==============================================================================
/**
 Represents a voice that a BKFixedNoteSynthesiser can use to play a BKFixedNoteSynthesiserSound.
 
 A voice plays a single sound at a time, and a BKFixedNoteSynthesiser holds an array of
 voices so that it can play polyphonically.
 
 @see BKFixedNoteSynthesiser, BKFixedNoteSynthesiserSound
 */
class  BKFixedNoteSynthesiserVoice
{
public:
    //==============================================================================
    /** Creates a voice. */
    BKFixedNoteSynthesiserVoice();
    
    /** Destructor. */
    virtual ~BKFixedNoteSynthesiserVoice();
     ...
     */
    BKFixedNoteSynthesiserSound::Ptr getCurrentlyPlayingSound() const noexcept     { return currentlyPlayingSound; }
     ...
     */
    virtual bool canPlaySound (BKFixedNoteSynthesiserSound*) = 0;
    ...
    /** Renders the next block of data for this voice.
     ...
     block, it must call clearCurrentNote(), to tell the BKFixedNoteSynthesiser that it has finished.
    ...
    bool wasStartedBefore (const BKFixedNoteSynthesiserVoice& other) const noexcept;
...
private:
    //==============================================================================
    friend class BKFixedNoteSynthesiser;
    ...
    JUCE_LEAK_DETECTOR (BKFixedNoteSynthesiserVoice)
};
...
/**
 ...
 To create a BKFixedNoteSynthesiser, you'll need to create a subclass of BKFixedNoteSynthesiserSound
 to describe each sound available to your synth, and a subclass of BKFixedNoteSynthesiserVoice
 which can play back one of these sounds.
 
 Then you can use the addVoice() and addSound() methods to give the BKFixedNoteSynthesiser a
 ...
 */
class JUCE_API  BKFixedNoteSynthesiser
{
public:
    //==============================================================================
    /** Creates a new BKFixedNoteSynthesiser.
     You'll need to add some sounds and voices before it'll make any sound.
     */
    BKFixedNoteSynthesiser();
    
    /** Destructor. */
    virtual ~BKFixedNoteSynthesiser();
    ...
    BKFixedNoteSynthesiserVoice* getVoice (int index) const;
    
    /** Adds a new voice to the synth.
     
     All the voices should be the same class of object and are treated equally.
     
     The object passed in will be managed by the BKFixedNoteSynthesiser, which will delete
     it later on when no longer needed. The caller should not retain a pointer to the
     voice.
     */
    BKFixedNoteSynthesiserVoice* addVoice (BKFixedNoteSynthesiserVoice* newVoice);
    ...
    BKFixedNoteSynthesiserSound* getSound (int index) const noexcept           { return sounds [index]; }
    
    /** Adds a new sound to the BKFixedNoteSynthesiser.
     
     The object passed in is reference counted, so will be deleted when the
     BKFixedNoteSynthesiser and all voices are no longer using it.
     */
    BKFixedNoteSynthesiserSound* addSound (const BKFixedNoteSynthesiserSound::Ptr& newSound);
    ...
    //==============================================================================
    /** Tells the BKFixedNoteSynthesiser what the sample rate is for the audio it's being used to render.
...
protected:
    ...
    OwnedArray<BKFixedNoteSynthesiserVoice> voices;
    ReferenceCountedArray<BKFixedNoteSynthesiserSound> sounds;
     ...
     */
    virtual BKFixedNoteSynthesiserVoice* findFreeVoice (BKFixedNoteSynthesiserSound* soundToPlay,
                                               int midiChannel,
                                               int midiNoteNumber,
     ...
     */
    virtual BKFixedNoteSynthesiserVoice* findVoiceToSteal (BKFixedNoteSynthesiserSound* soundToPlay,
                                                  int midiChannel,
     ...
     */
    void startVoice (BKFixedNoteSynthesiserVoice* voice,
                     BKFixedNoteSynthesiserSound* sound,
                     int midiChannel,
                     int midiNoteNumber,
                     float velocity,
    ...
    /** Stops a given voice.
     ...
     BKFixedNoteSynthesiserVoice::stopNote(), and has some assertions to sanity-check a few things.
     */
    void stopVoice (BKFixedNoteSynthesiserVoice*, float velocity, bool allowTailOff);
...
private:
    ...
    virtual int findFreeVoice (BKFixedNoteSynthesiserSound*, const bool) { return 0; }
    virtual int findVoiceToSteal (BKFixedNoteSynthesiserSound*) const { return 0; }
#endif
    
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BKFixedNoteSynthesiser)
};

#endif  // BKFIXEDNOTESYNTHESISER_H_INCLUDED
