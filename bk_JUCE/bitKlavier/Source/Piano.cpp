...
{
    ResonanceProcessor::Ptr rproc = new ResonanceProcessor(processor.gallery->getResonance(thisId), defaultT, processor.gallery->getGeneralSettings(), processor/*, &processor.mainPianoSynth*/);
