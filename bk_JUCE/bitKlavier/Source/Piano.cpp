...
{
    ResonanceProcessor::Ptr rproc = new ResonanceProcessor(processor.gallery->getPreparationOfType(PreparationTypeResonance, thisId), defaultT, processor.gallery->getGeneralSettings(), processor/*, &processor.mainPianoSynth*/);
