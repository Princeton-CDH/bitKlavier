...
void NostalgicPreparation::attachToSynth(BKSynthesiser *s)
{
    synth = s;
...
void NostalgicPreparation::playNote(int midiNoteNumber, int midiChannel) {
...
void NostalgicPreparation::noteLengthTimerOn(int midiNoteNumber, float midiNoteVelocity)
{
...
void NostalgicPreparation::noteLengthTimerOff(int midiNoteNumber)
{
...
//start timer for length of a particular note; called when key is pressed
void NostalgicPreparation::reverseNoteLengthTimerOn(int midiNoteNumber, float noteLength)
{
...
void NostalgicPreparation::keymapSet(int midiNoteNumber, bool on)
{
...
void NostalgicPreparation::processBlock(int numSamples, int midiChannel)
{
...
//get length of note
int NostalgicPreparation::getNoteLengthTimer(int midiNoteNumber) const noexcept
{
...
//get length of note
int NostalgicPreparation::getReverseNoteLengthTimer(int midiNoteNumber) const noexcept
{
